...
const STRINGS = {
  'zh-Hant': {
    ...
    discard: '棄牌',
    noMoves: '沒有可出的牌，請棄一張',
    confirmDiscard: '這張牌沒有地方可以出，要捨棄它嗎？',
    ...
    rulesBody: [
      ...
      '小熊：吃掉一個沒蓋蓋子罐子裡的蜂蜜，數量如牌面（吃 3 的熊一定吃滿 3，不夠才全吃，不能只吃一部分）。必須優先吃能餵飽牠的罐子：吃 3 的熊要先吃有 3 份以上蜂蜜的罐子（自己或別人的都行），沒有才吃 2 份、再沒有才吃 1 份的罐子；吃 2 的熊要先吃 2 份以上蜂蜜的罐子，有 2 份的就不能只吃 1 份的。',
  ...
  en: {
    ...
    confirmDiscard: 'This card has nowhere to be played. Discard it?',
    ...
    rulesBody: [
      ...
      'Bear: eats honey from one uncovered jar, exactly the amount shown (a 3-bear always eats a full 3, or all of it if there’s less — never a partial nibble). It must go for a jar that fills it up first: a 3-bear must target a 3+-honey jar (yours or a rival’s) if one exists, only then a 2-honey, then a 1-honey jar; a 2-bear must target a 2+-honey jar over a 1-honey one.',
